...
export default function InstagramFeed({ instagramUrl }: InstagramFeedProps) {
  ...
  return (
    <div className="bg-white border border-border rounded-lg p-6">
      ...
      <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 rounded-lg p-6 mb-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600">
              Las fotos y contenido de este perfil están disponibles en Instagram.
              Haz clic abajo para ver el portafolio completo.
            </p>
          </div>
        </div>
      </div>

      {/* Botón grande y llamativo para ver Instagram */}
      <a
        href={instagramUrl}
        target="_blank"
        rel="noopener noreferrer"
      ...
      >
        <div className="group relative overflow-hidden bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 rounded-lg p-4 hover:shadow-lg transition-all duration-300">
      ...
      <div className="mt-4 grid grid-cols-3 gap-3">
        <div className="text-center p-3 bg-surface rounded-lg">
          <div className="text-xs text-text-muted mb-1">Posts</div>
        ...
        <div className="text-center p-3 bg-surface rounded-lg">
          <div className="text-xs text-text-muted mb-1">Fotos</div>
          <div className="text-lg font-bold text-primary">
            <svg className="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center p-3 bg-surface rounded-lg">
          <div className="text-xs text-text-muted mb-1">Videos</div>
          <div className="text-lg font-bold text-primary">
            <svg className="w-5 h-5 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
